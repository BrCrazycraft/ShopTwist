...
let teste = new ProductMain("../../caminhoParaPNG.png", "Teste", "Descrição Foda", 123.4, "Amazon", "https://www.google.com");
let content = teste.criar();

if (content !== null) {
    document.getElementById("product-List").appendChild(content);
}
